...
const Navbar = () => {
    ...
    return (
        <nav className="w-full h-fit py-4 px-8 mt-0 bg-linear-to-r from-emerald-700 to-green-600 dark:from-emerald-950 dark:to-green-900 border-b-emerald-500 text-white flex justify-between">
